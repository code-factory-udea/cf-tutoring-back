...
public class AdministrationController {
    ...
    public ResponseEntity<UserPaginationDTO> getStudents(@RequestParam int page) {
        return new ResponseEntity<>(this.adminService.getUsersByRole(RoleConstants.STUDENT_ID, page), null, 200);
    }
    ...
    public ResponseEntity<UserPaginationDTO>  getTutors(@RequestParam int page) {
        return new ResponseEntity<>(this.adminService.getUsersByRole(RoleConstants.TUTOR_ID, page), null, 200);
    }
    ...
    public ResponseEntity<UserPaginationDTO> getProfessors(@RequestParam int page) {
        return new ResponseEntity<>(this.adminService.getUsersByRole(RoleConstants.PROFESSOR_ID, page), null, 200);
    }
    ...
    public ResponseEntity<UserPaginationDTO> getAdmins(@RequestParam int page) {
        return new ResponseEntity<>(this.adminService.getUsersByRole(RoleConstants.ADMIN_ID, page), null, 200);
    }
    ...
    public ResponseEntity<UserPaginationDTO> getNotIdentifiedUsers(@RequestParam int page) {
        return new ResponseEntity<>(this.adminService.getUsersByRole(RoleConstants.UNKNOWN_ID, page), null, 200);
    }
