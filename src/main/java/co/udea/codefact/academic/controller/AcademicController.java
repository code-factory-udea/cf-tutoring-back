...
public class AcademicController {
    ...
    public ResponseEntity<List<AcademicProgramResponseDTO>> getAcademicPrograms(@RequestParam Long facultyId) {
        return new ResponseEntity<>(this.academicService.getAcademicPrograms(facultyId), HttpStatus.OK);
    }
